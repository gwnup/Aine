...
const handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    const api = await fetch(`https://genshin-db-api.vercel.app/api/characters?query=${text}&matchCategories=true&dumpResult=true&queryLanguages=English&resultLanguage=Indonesian`);
    const { match } = await api.json();
