...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    let response = await fetch(`https://genshin-db-api.vercel.app/api/characters?query=${text}&matchCategories=true&dumpResult=true&queryLanguages=English&resultLanguage=Indonesian`);
    let { result, matchtype } = await response.json();
